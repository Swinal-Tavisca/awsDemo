...
export class DataComponent implements OnInit {
  ...
  ngOnInit() {
    this.http.get('http://thingstodoproject-dev.ap-south-1.elasticbeanstalk.com/api/Data/'+ this.airportServices.area + '/' + this.location +'/' + this.arrivalDatetime +'/' +  this.DepartureDateTime +'/' + this.type).
    subscribe((response)=>
    {
