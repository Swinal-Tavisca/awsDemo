...
export class HeaderComponent implements OnInit {
  ...
  check() {
    ...
    this.http.get('http://thingstodoproject-dev.ap-south-1.elasticbeanstalk.com/api/Data/search' +'/'+ this.location +'/' + this.arrivalDatetime +'/' +  this.DepartureDateTime +'/' + this.airportServices.getInput()).
   subscribe((response)=>
   {
